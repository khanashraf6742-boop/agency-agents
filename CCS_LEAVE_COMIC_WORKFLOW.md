...
| Rule 22(1)(ii), 22(3), NOTE — Medical prefix/suffix, pay effect, compensatory leave | Pending regeneration (Panel 3 pay-date flowchart failed audit) | `ccs-leave-rule-22-part-2-hinglish.png` (DO NOT USE current file) | Must re-verify against official consolidated version updated 24.09.2024 before regenerating |
